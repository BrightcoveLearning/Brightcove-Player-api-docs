...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        shell: {
            ...
            cloneVideoJS: {
                ...
                command: 'rm -rf ./video.js && git clone -b 5.x --single-branch https://github.com/videojs/video.js.git'
            },
        },
        concat: {
            dist: {
    ...
    grunt.task.registerTask('createFiles', 'Create files into which docs will be injected', function () {
        var classData = [],
            docData = '',
            contentStr = '<!DOCTYPE html> <html lang="en"> <head> <meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> <meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, user-scalable=no, width=device-width" /><title></title> <link rel="stylesheet" type="text/css" href="//cdnjs.cloudflare.com/ajax/libs/foundation/5.5.3/css/foundation.min.css"> <link rel="stylesheet" type="text/css" href="//cdnjs.cloudflare.com/ajax/libs/foundation/5.5.3/css/normalize.css"> <script src="//use.edgefonts.net/source-code-pro.js">//comment</script> <link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,400,700" rel="stylesheet" type="text/css"> <link rel="stylesheet" type="text/css" href="//docs.brightcove.com/en/styles/bcls-doc-site.css"> <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.9.1/styles/atelier-forest.light.min.css"> <link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,400,700" rel="stylesheet" type="text/css"> <script> (function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o), m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m) })(window,document,"script","//www.google-analytics.com/analytics.js","ga"); ga("create", "UA-2728311-29", "auto"); ga("send", "pageview"); </script> <script src="//cdnjs.cloudflare.com/ajax/libs/foundation/5.5.3/js/vendor/modernizr.js">//comment</script><style>.sideNav {position:absolute;left:4em;overflow-y:scroll;overflow-x:hidden;font-size: .8em;padding-left: 0;margin-left:0;} .sideNav h2  {margin-top: -2em; margin-left:margin-bottom:.1em;font-size: 1.4em;} .sideNav h3 {margin-left:0;margin-bottom:.1em;margin-top:.2em;padding-top:0;font-size: 1.2em;} .sideNav h4 {margin-left:0;margin-bottom:.1em;margin-top:.2em;padding-top:0;font-size: 1em;} .sideNav ul {list-style-type:none;margin-left:0;} .sideNav li {margin-bottom:.1em;margin-top:.2em;padding-top:.1em; padding-bottom:.1em font-size: .8em;} .sideNav li a {margin-bottom:.1em;padding:.1em;font-size: .8em;} </style> </head><body><div id="navWrapper" class="fixed"><!-- header navbar --> </div>  <nav id="breadCrumbWrapper" class="breadcrumbs show-for-medium-up"><!-- breadcrumbs --></nav>  <div id="searchModal" class="reveal-modal" data-reveal><!-- search --></div>  <div class="row"><div id="inPageNav"><!-- sidenav --></div>  <div id="main" class="large-10 small-12 columns"><!-- content --></div> </div></body> </html>',
                ...
                addHeaderContent(function () {
                    addMembersContent(function () {
                        ...
                        var footer = createEl('div', {'class': 'footer text-center'}),
                            ...
                            addText(scriptEl, '//comment \n');
                            doc_body.appendChild(scriptEl);
                            scriptEl = createEl('script', {'src': '//cdnjs.cloudflare.com/ajax/libs/foundation/5.5.3/js/foundation.min.js'});
                            addText(scriptEl, '//comment \n');
                            doc_body.appendChild(scriptEl);
                            ...
                            addText(scriptEl, '//comment \n');
                            doc_body.appendChild(scriptEl);
                            scriptEl = createEl('script', {'src': '//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.9.1/highlight.min.js'});
                            addText(scriptEl, '//comment \n');
                            doc_body.appendChild(scriptEl);
